...
<ul>
   ...
   <li>Added full CRUD functionality: add, edit, delete articles. Symfony forms used for adding and updating articles. Added extra validation constraints using Symfony Validator component.</li>

   <li>Added read-time functionality with services. Average read-times displayed for all articles in the index page and in each article page.</li>
