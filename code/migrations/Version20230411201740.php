 ...
 */
final class Version20230411201740 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD COLUMN readtime DOUBLE PRECISION');
        $this->addSql('ALTER TABLE article ADD COLUMN updated_at DATETIME');
    }
