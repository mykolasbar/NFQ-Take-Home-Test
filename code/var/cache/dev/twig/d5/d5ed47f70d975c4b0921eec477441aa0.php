...
class __TwigTemplate_cb97ce0b938a16dae0bbbbad9a4cdde2 extends Template
{
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        // line 16
        (((twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 16, $this->source); })()), "updatedAt", [], "any", false, false, false, 16) != null)) ? (print (twig_escape_filter($this->env, (isset($context["date"]) || array_key_exists("date", $context) ? $context["date"] : (function () { throw new RuntimeError('Variable "date" does not exist.', 16, $this->source); })()), "html", null, true))) : (print ("No updates made.")));
        echo "</div>
    ...
    <main>
        <div class=\"py-5 bg-light\">
            <div class=\"container\">
                ...
                <div class=\"mt-4 mb-4\"><b>Article last updated at:</b> {{ article.updatedAt != null ? date : \"No updates made.\" }}</div>
